...
$(TARGET_GENERATED_BOOTANIMATION): $(SOONG_ZIP)
	@echo "Building bootanimation.zip $(TARGET_SCREEN_HEIGHT)x$(TARGET_SCREEN_WIDTH)"
	@rm -rf $(dir $@)
	@mkdir -p $(INTERMEDIATES)
	$(hide) tar xfp vendor/blackduck/bootanimation/bootanimation.tar -C $(INTERMEDIATES)
	...
	vendor/blackduck/bootanimation/bin/${HOST_OS}-x86/mogrify -resize $$RESOLUTION -colors 250 $(INTERMEDIATES)/*/*.png; \
	echo "$$IMAGESCALEWIDTH $$IMAGESCALEHEIGHT 30" > $(INTERMEDIATES)/desc.txt; \
	cat vendor/blackduck/bootanimation/desc.txt >> $(INTERMEDIATES)/desc.txt
